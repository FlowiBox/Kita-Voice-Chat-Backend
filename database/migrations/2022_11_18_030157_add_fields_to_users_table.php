...
class AddFieldsToUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            $table->double ('white_diamond')->default (0)->nullable ()->comment ('');
            $table->double ('red_diamond')->default (0)->nullable ()->comment ('');
            $table->double ('blue_diamond')->default (0)->nullable ()->comment ('');
            $table->double ('green_diamond')->default (0)->nullable ()->comment ('');
            $table->double ('black_diamond')->default (0)->nullable ()->comment ('');
            $table->double ('pink_diamond')->default (0)->nullable ()->comment ('');
            $table->double ('coin')->default (0)->nullable ()->comment ('');
            $table->double ('usd')->default (0)->nullable ()->comment ('');
