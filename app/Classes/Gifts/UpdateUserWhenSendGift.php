...
class UpdateUserWhenSendGift
{
    ...
    public function update(int $totalCoins, User $receivedUser)
    {
        ...
        // update levels
        $receivedUser->received_level = $this->getLevel(1, $receivedUser->monthly_diamond_received);
        //
    ...
    public function send(int $totalCoins, User $senderUser)
    {
        ...
        $senderUser->sender_level         = $this->getLevel(3, $senderUser->monthly_diamond_send);
        $senderUser->save();
